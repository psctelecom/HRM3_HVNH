...
{
    public partial class TruyLuong_TinhTruyLuongController: ViewController
    {
        public TruyLuong_TinhTruyLuongController()
        {
            InitializeComponent();
            RegisterActions(components);
        }

        private void TruyLuong_TinhTruyLuongController_Activated(object sender, EventArgs e)
        {
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (bangTruyLuong != null)
            {
                using (DialogUtil.AutoWait())
                {
                    ...
                    {
                        //Tính dữ liệu mới
                        SystemContainer.Resolver<ITaiChinh>("TinhTruyLuong").XuLy(View.ObjectSpace, bangTruyLuong, null);
