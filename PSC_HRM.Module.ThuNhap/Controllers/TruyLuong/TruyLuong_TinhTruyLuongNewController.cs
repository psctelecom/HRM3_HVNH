...
{
    public partial class TruyLuong_TinhTruyLuongNewController: ViewController
    {
        public TruyLuong_TinhTruyLuongNewController()
        {
            InitializeComponent();
            RegisterActions(components);
        }

        private void TruyLuong_TinhTruyLuongNewController_Activated(object sender, EventArgs e)
        {
        ...
        public void XuLy(IObjectSpace obs, BaseObject obj)
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_TaiChinh_TruyLuong_TinhTruyLuong_New");
