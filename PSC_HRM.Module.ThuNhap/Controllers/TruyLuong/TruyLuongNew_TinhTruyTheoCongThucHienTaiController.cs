...
{
    public partial class TruyLuongNew_TinhTruyTheoCongThucHienTaiController: ViewController
    {
        public TruyLuongNew_TinhTruyTheoCongThucHienTaiController()
        {
            InitializeComponent();
            RegisterActions(components);
        }

        private void TruyLuongNew_TinhTruyTheoCongThucHienTaiController_Activated(object sender, EventArgs e)
        {
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (bangTruyLuong != null)
            {
                ...
                //
                DialogUtil.ShowInfo("Truy lĩnh lương thành công.");
            }
        }
        ...
        public void XuLy(IObjectSpace obs, BaseObject obj)
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_TaiChinh_TruyLuongNew_TinhTruyLuongTheoCongThucHienTai");
