...
{
    public class TinhQuyetToanThueTNCN : ITaiChinh
    {
        public void XuLy(IObjectSpace obs, BaseObject obj, XPCollection<CongThucTinhLuong> congThucTinhLuongList)
        {
            ...
            {
                Utils.XuLyDuLieu(((XPObjectSpace)obs).Session, "spd_TaiChinh_ThueTNCN_TinhQuyetToanThueTNCN", CommandType.StoredProcedure, new SqlParameter("@ToKhai", obj.Oid));
            }
        }
    }
}
