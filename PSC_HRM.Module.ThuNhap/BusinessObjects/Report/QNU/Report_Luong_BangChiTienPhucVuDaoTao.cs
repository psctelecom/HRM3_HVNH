...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng chi tiền phục vụ đào tạo")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangChiTienPhucVuDaoTao : StoreProcedureReport
    {
        ...
        public Report_Luong_BangChiTienPhucVuDaoTao(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangChiTienPhucVuDaoTao", (SqlConnection)Session.Connection))
            {
