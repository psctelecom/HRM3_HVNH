...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng chuyển khoản chi tiền trách nhiệm, quản lý")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangChuyenKhoanChiTienTrachNhiemQuanLy : StoreProcedureReport
    {
        ...
        public Report_Luong_BangChuyenKhoanChiTienTrachNhiemQuanLy(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangChuyenKhoanChiTienTrachNhiemQuanLy", (SqlConnection)Session.Connection))
            {
