...
{ 
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng chuyển khoản chi tiền điện thoại")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangChuyenKhoanChiTienDienThoai : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangChuyenKhoanChiTienDienThoai(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangChuyenKhoanChiTienDienThoai", (SqlConnection)Session.Connection))
            {
