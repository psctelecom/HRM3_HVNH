...
namespace PSC_HRM.Module.ThuNhap.TruyLuong
{
    ...
    [ModelDefault("Caption", "Bảng truy lĩnh khác")]
    [Appearance("BangTruyLuong.KhoaSo", TargetItems = "*", Enabled = false, Criteria = "(KyTinhLuong is not null and KyTinhLuong.KhoaSo) or ChungTu is not null")]
    [RuleCombinationOfPropertiesIsUnique("BangTruyLinhKhac.Unique", DefaultContexts.Save, "KyTinhLuong;ThongTinTruong")]
    public class BangTruyLinhKhac : BaseObject, IThongTinTruong
    {
        ...
        [Aggregated]
        [ModelDefault("Caption", "Danh sách truy lĩnh khác")]
        [Association("BangTruyLinhKhac-ListTruyLinhKhac")]
        public XPCollection<TruyLinhKhac> ListTruyLinhKhac
        {
            get
            {
                return GetCollection<TruyLinhKhac>("ListTruyLinhKhac");
            }
        }

        public BangTruyLinhKhac(Session session) : base(session) { }
