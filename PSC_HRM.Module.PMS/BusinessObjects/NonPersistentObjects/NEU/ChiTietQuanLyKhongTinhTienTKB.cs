...
{
    [NonPersistent]
    [ModelDefault("Caption", "Không tính tiền TKB")]
    public class ChiTietQuanLyKhongTinhTienTKB : BaseObject
    {
        private bool _Chon;
        [ModelDefault("AlowEdit", "true")]
        ...
        private bool _KhongTinTien;
        [ModelDefault("Caption", "Không tính tiền")]
        [ModelDefault("AlowEdit", "false")]
        public bool KhongTinTien
        {
            get { return _KhongTinTien; }
            set { _KhongTinTien = value; }
        }

        public ChiTietQuanLyKhongTinhTienTKB(Session session)
            : base(session)
        {
