...
{
    [NonPersistent]
    [ModelDefault("Caption", "Chi tiết dữ liệu chưa thanh toán")]
    public class ChiTietDuLieuChuaThanhToan : BaseObject
    {
        private bool _Chon;
        ...
        public ChiTietDuLieuChuaThanhToan(Session session)
            : base(session)
        {
