...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo chi tiết thanh toán thỉnh giảng(VHU)")]
    public class PMS_ThanhToanThuLaoGiangDay_ChiTiet_NonBaoCao : BaseObject
    {
        ...
        public XPCollection<Report_PMS_ThanhToanThuLaoGiangDay_ChiTiet_Non> ListDanhSach { get; set; }

        public PMS_ThanhToanThuLaoGiangDay_ChiTiet_NonBaoCao(Session session)
            : base(session)
        {
        ...
        public void LoadData()
        {
            ...
            if (dataset != null)
            {
                ...
                if (ListDanhSach != null)
                    ...
                    ListDanhSach = new XPCollection<Report_PMS_ThanhToanThuLaoGiangDay_ChiTiet_Non>(Session, false);
                foreach (DataRow itemRow in dt.Rows)
                {
                    Report_PMS_ThanhToanThuLaoGiangDay_ChiTiet_Non ds = new Report_PMS_ThanhToanThuLaoGiangDay_ChiTiet_Non(Session);
                    ...
                    ds.SoTietThucDay = Convert.ToDecimal(itemRow["SoTietThucDay"]);
