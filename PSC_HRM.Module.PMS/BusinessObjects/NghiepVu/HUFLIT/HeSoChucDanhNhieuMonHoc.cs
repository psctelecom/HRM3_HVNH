...
namespace PSC_HRM.Module.PMS.NghiepVu.NCKH
{
    ...
    [ModelDefault("Caption", "Hệ số chức danh từng môn")]
    public class HeSoChucDanhNhieuMonHoc : BaseObject
    {
        ...
        public HeSoChucDanhNhieuMonHoc(Session session) : base(session) { }
