...
namespace PSC_HRM.Module.PMS.NghiepVu.HUFLIT
{
    ...
    [ModelDefault("Caption", "Chi tiết môn học đơn giá thanh toán")]
    [NonPersistent]
    [DefaultProperty("Caption")]
    public class ChiTietDanhSachDanhSachDonGiaThanhToan : BaseObject
    {
        private bool _Chon;
        ...
        public ChiTietDanhSachDanhSachDonGiaThanhToan(Session session) : base(session) { }
