...
namespace PSC_HRM.Module.PMS.NghiepVu.HUFLIT
{
    ...
    [ModelDefault("Caption", "Danh sách môn học nhiều hệ số chức danh")]
    [NonPersistent]
    [DefaultProperty("Caption")]
    public class DanhSachMonHocNhieuChucDanh : BaseObject
    {
        ...
        public XPCollection<ChiTietDanhSachMonHocNhieuChucDanh> ListDanhSach
        {
            get;
            set;
        }
        ...
        public DanhSachMonHocNhieuChucDanh(Session session) : base(session) { }
        ...
        public void LoadData()
        {
            if (NamHoc != null && HocKy != null)
            {
                if (ListDanhSach != null)
                    ...
                    ListDanhSach = new XPCollection<ChiTietDanhSachMonHocNhieuChucDanh>(Session, false);
                ...
                SqlCommand cmd = DataProvider.GetCommand("spd_PMS_HUFLIT_DanhSachMonHocNhieuChucDanh", CommandType.StoredProcedure, param);
                ...
                if (dataset != null)
                {
                    ...
                    {
                        ChiTietDanhSachMonHocNhieuChucDanh ds = new ChiTietDanhSachMonHocNhieuChucDanh(Session);
                        ...
                        ds.HeSo = Convert.ToDecimal(itemRow["HeSo"]);
                        ListDanhSach.Add(ds);
                    }
                }
            }
