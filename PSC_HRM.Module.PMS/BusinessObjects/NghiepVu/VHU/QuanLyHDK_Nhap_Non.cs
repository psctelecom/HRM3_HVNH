...
{
    [ModelDefault("Caption", "Quản lý nhập HDK(Non)")]
    [NonPersistent]
    public class QuanLyHDK_Nhap_Non : BaseObject
    {
        ...
        public QuanLyHDK_Nhap_Non(Session session) : base(session) { }
            ...
            if (NamHoc != null)
            {
                ...
                if (dataset != null)
                {
                    ...
                    foreach (DataRow itemRow in dt.Rows)
                    {
                        ...
                        ds.ThanhToanTienMat = Convert.ToBoolean(itemRow["ThanhToanTienMat"].ToString());
                        ds.SoTienThanhToan = Convert.ToDecimal(itemRow["SoTienThanhToan"].ToString());
