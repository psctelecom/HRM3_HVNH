...
namespace PSC_HRM.Module.PMS.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền vượt giờ định mức")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_ThuLao_BangThanhToanTienVuotGioDinhMuc : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_ThuLao_BangThanhToanTienVuotGioDinhMuc(Session session) : base(session) { }
