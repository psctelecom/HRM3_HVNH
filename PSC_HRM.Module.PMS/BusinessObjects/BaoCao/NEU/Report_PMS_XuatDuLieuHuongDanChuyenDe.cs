...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Xuất dữ liệu hướng dẫn chuyên đề")]
    public class Report_PMS_XuatDuLieuHuongDanChuyenDe : StoreProcedureReport
    {
        ...
        public Report_PMS_XuatDuLieuHuongDanChuyenDe(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_HuongDanChuyenDe", (SqlConnection)Session.Connection))
            {
