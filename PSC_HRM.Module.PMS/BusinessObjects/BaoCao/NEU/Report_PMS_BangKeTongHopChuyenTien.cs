...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng kê tổng hợp chuyển tiền")]
    public class Report_PMS_BangKeTongHopChuyenTien : StoreProcedureReport
    {
        ...
        public Report_PMS_BangKeTongHopChuyenTien(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_BangKeTongHopChuyenTien", (SqlConnection)Session.Connection))
            {
