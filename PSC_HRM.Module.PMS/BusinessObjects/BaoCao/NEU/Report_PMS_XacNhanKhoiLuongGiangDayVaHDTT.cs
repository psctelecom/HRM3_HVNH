...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Xác nhận khối lượng giảng dạy và HDTT")]
    public class Report_PMS_XacNhanKhoiLuongGiangDayVaHDTT : StoreProcedureReport
    {
        ...
        public Report_PMS_XacNhanKhoiLuongGiangDayVaHDTT(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_XacNhanKhoiLuongGiangDay_HDTT", (SqlConnection)Session.Connection))
            {
                if (TimKiem == null)
                    NhanVien = null;
