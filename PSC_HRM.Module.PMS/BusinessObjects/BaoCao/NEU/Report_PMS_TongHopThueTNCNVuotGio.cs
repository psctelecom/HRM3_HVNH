...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp thuế TNCN giảng vượt giờ")]
    public class Report_PMS_TongHopThueTNCNVuotGio : StoreProcedureReport
    {
        ...
        public Report_PMS_TongHopThueTNCNVuotGio(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_TongHopThueTNCNVuotGio", (SqlConnection)Session.Connection))
            {
