...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp khối lượng giảng dạy")]
    public class Report_PMS_BangTongHopKhoiLuongGiangDay : StoreProcedureReport
    {
        ...
        public NamHoc NamHoc
        {
            ...
            set
            {
                ...
                if (!IsLoading)
                    if (NamHoc != null)
                        HocKy = null;//Session.FindObject<HocKy>(CriteriaOperator.Parse("MaQuanLy =? and NamHoc =?", "HK01", NamHoc.Oid));
            }
        }
        ...
        public Report_PMS_BangTongHopKhoiLuongGiangDay(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_BangTongHopKhoiLuongGiangDay", (SqlConnection)Session.Connection))
            {
