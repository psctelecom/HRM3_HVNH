...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng kê khai giảng viên không đủ giờ")]
    public class Report_PMS_KeKhaiGiangVienKhongDuGio : StoreProcedureReport
    {
        ...
        public Report_PMS_KeKhaiGiangVienKhongDuGio(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_KeKhaiGVKhongDuGio", (SqlConnection)Session.Connection))
            {
                if (TimKiem == null)
                    NhanVien = null;
