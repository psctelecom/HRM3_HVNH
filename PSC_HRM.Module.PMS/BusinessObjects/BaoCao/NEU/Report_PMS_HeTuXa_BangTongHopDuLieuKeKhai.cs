...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp dữ liệu kê khai từ xa")]
    public class Report_PMS_HeTuXa_BangTongHopDuLieuKeKhai : StoreProcedureReport
    {
        ...
        public Report_PMS_HeTuXa_BangTongHopDuLieuKeKhai(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_HeTuXa_BangTongHopDuLieuKeKhai", (SqlConnection)Session.Connection))
            {
