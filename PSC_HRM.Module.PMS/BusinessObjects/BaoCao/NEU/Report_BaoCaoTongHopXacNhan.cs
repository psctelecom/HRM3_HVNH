...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp tình trạng xác nhận thanh toán")]
    public class Report_BaoCaoTongHopXacNhan : StoreProcedureReport
    {
        ...
        private LoaiXacNhanThanhToan _LoaiXacNhan;
        ...
        [ModelDefault("Caption", "Loại xác nhận")]
        public LoaiXacNhanThanhToan LoaiXacNhan
        {
            get { return _LoaiXacNhan; }
            set { SetPropertyValue("LoaiXacNhan", ref _LoaiXacNhan, value); }
        }
        ...
        public Report_BaoCaoTongHopXacNhan(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_BaoCaoTongHopXacNhan", (SqlConnection)Session.Connection))
            {
                ...
                da.SelectCommand.Parameters.AddWithValue("@LoaiXacNhan", LoaiXacNhan.GetHashCode());
                da.Fill(DataSource);
            }
        }
    }
