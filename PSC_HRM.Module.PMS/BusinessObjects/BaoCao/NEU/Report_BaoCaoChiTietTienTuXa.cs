...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp chi tiết tiền từ xa")]
    public class Report_BaoCaoChiTietTienTuXa : StoreProcedureReport
    {
        ...
        //}
        public Report_BaoCaoChiTietTienTuXa(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_BaoCaoChiTietTienTuXa", (SqlConnection)Session.Connection))
            {
