...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Xem giờ giảng của giảng viên (thỉnh giảng)")]
    public class Report_PMS_ThongKeGioGiangThinhGiang : StoreProcedureReport
    {
        ...
        public Report_PMS_ThongKeGioGiangThinhGiang(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_GiangVienThinhGiang_ThongKeGioGiang", (SqlConnection)Session.Connection))
            {
