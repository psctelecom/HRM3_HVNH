...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán lương chuyên gia quy ra giờ(Đợt 2)")]
    public class Report_PMS_BangTTTienLuongChuyenGiaQuyRaGio_Dot2 : StoreProcedureReport
    {
       ...
       public void UpdateBangChot()
        ...
        public Report_PMS_BangTTTienLuongChuyenGiaQuyRaGio_Dot2(Session session) : base(session) { }
