...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền lương Chuyên Gia(Đợt 2)")]
    public class Report_PMS_ThanhToanTienLuongChuyenGia_Dot2 : StoreProcedureReport
    {
        ...
        public Report_PMS_ThanhToanTienLuongChuyenGia_Dot2(Session session) : base(session) { }
