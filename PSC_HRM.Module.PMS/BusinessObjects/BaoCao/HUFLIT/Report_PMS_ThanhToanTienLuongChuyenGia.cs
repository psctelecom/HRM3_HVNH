...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền lương Chuyên Gia")]
    public class Report_PMS_ThanhToanTienLuongChuyenGia : StoreProcedureReport
    {
        ...
        public Report_PMS_ThanhToanTienLuongChuyenGia(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_BangThanhToanTienLuong_ChuyenGia", (SqlConnection)Session.Connection))
            {
