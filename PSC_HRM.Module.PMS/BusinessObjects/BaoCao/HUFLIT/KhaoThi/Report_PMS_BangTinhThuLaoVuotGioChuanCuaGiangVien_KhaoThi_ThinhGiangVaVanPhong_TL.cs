...
namespace PSC_HRM.Module.PMS.BaoCao
{
    ...
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo :Bảng tính thù lao vượt chuẩn của giảng viên ( khảo thí ) tính cho Thỉnh Giảng,Văn Phòng (TL)")]
    public class Report_PMS_BangTinhThuLaoVuotGioChuanCuaGiangVien_KhaoThi_ThinhGiangVaVanPhong_TL : StoreProcedureReport
    {   
        public Report_PMS_BangTinhThuLaoVuotGioChuanCuaGiangVien_KhaoThi_ThinhGiangVaVanPhong_TL(Session session)
            : base(session)
        {
        }
        ...
        [ImmediatePostData]
        [RuleRequiredField("NamHocPhaiTonTai_KhaoThi_TGVP_TL", DefaultContexts.Save, "Năm học phải có")]
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_PMS_BangTinhThuLaoVuotGioChuanCuaGiangVien_KhaoThi_ThinhGiangVaVanPhong_TL", (SqlConnection)Session.Connection))
            {
