...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán giờ giảng dạy thỉnh giảng")]
    public class Report_PMS_ThanhToanGioGiang_ThinhGiang : StoreProcedureReport
    {
        ...
        public Report_PMS_ThanhToanGioGiang_ThinhGiang(Session session) : base(session) { }
