...
namespace PSC_HRM.Module.PMS.BaoCao
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán lương chuyên gia quy ra giờ")]
    public class Report_PMS_BangTTTienLuongChuyenGiaQuyRaGio : StoreProcedureReport
    {
        ...
        public Report_PMS_BangTTTienLuongChuyenGiaQuyRaGio(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_BangThanhToanTienLuong_ChuyenGia_QuyRaGio", (SqlConnection)Session.Connection))
            {
