...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Giảng viên chưa hoàn thành định mức giờ NCKH")]
    public class Report_PMS_ThieuGioNCKH : StoreProcedureReport
    {
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_ThieuGioNCKH", (SqlConnection)Session.Connection))
            {
        ...
        public Report_PMS_ThieuGioNCKH(Session session) : base(session) { }
    }
}
