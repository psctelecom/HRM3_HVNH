...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng kê khai giờ giảng _ UFM")]
    public class Report_PMS_BangKeKhaiGioGiang : StoreProcedureReport
    {
        ...
        public Report_PMS_BangKeKhaiGioGiang(Session session) : base(session) { }
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_BangKeKhaiGioGiang", (SqlConnection)Session.Connection))
            {
