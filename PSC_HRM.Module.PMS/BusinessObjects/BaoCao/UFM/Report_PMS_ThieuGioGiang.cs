...
namespace PSC_HRM.Module.PMS.BusinessObjects.BaoCao.UFM
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Giảng viên chưa hoàn thành định mức giờ giảng")]
    public class Report_PMS_ThieuGioGiang :  StoreProcedureReport
    {
        ...
        {
            using (SqlDataAdapter da = new SqlDataAdapter("spd_PMS_Report_ThieuGioGiang", (SqlConnection)Session.Connection))
            {
        ...
        public Report_PMS_ThieuGioGiang(Session session) : base(session) { }
