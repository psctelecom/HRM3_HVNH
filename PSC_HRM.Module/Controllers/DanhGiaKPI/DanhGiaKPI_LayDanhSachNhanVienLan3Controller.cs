...
{
    public partial class DanhGiaKPI_LayDanhSachNhanVienLan3Controller : ViewController
    {
        public DanhGiaKPI_LayDanhSachNhanVienLan3Controller()
        {
            InitializeComponent();
            RegisterActions(components);
            HamDungChung.DebugTrace("DanhGiaKPI_LayDanhSachNhanVienLan3Controller");
        }
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (qldanhGia != null)
            {
                using (DialogUtil.AutoWait())
                {
                    ...
                    //
                    DataProvider.ExecuteNonQuery("dbo.spd_DanhGiaKPI_LayDanhSachNhanVienDanhGiaKPILan3", System.Data.CommandType.StoredProcedure, param);
        ...
        private void DanhGiaKPI_LayDanhSachNhanVienLan3Controller_Activated(object sender, EventArgs e)
        {
