...
{
    public partial class DanhGiaKPI_LayDanhSachNhanVienController : ViewController
    {
        public DanhGiaKPI_LayDanhSachNhanVienController()
        {
            InitializeComponent();
            RegisterActions(components);
            HamDungChung.DebugTrace("DanhGiaKPI_LayDanhSachNhanVienController");
        }
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (qldanhGia != null)
            {
                using (DialogUtil.AutoWait())
                {
                    ...
                    param[0] = new SqlParameter("@OidDanhGiaKPI", qldanhGia.Oid);
                    param[1] = new SqlParameter("@BoPhanList", sb.ToString());
                    //
                    DataProvider.ExecuteNonQuery("dbo.spd_DanhGiaKPI_LayDanhSachNhanVienDanhGiaKPI", System.Data.CommandType.StoredProcedure, param);
            ...
            { DialogUtil.ShowError("Chưa chọn kỳ tính lương."); }
        }

        private void DanhGiaKPI_LayDanhSachNhanVienController_Activated(object sender, EventArgs e)
        {
