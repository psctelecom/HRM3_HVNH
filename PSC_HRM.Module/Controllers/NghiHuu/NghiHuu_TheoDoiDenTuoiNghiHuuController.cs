...
{
    public partial class NghiHuu_TheoDoiDenTuoiNghiHuuController : ViewController
    {
        public NghiHuu_TheoDoiDenTuoiNghiHuuController()
        {
            InitializeComponent();
            RegisterActions(components);
        }

        private void NghiHuu_TheoDoiDenTuoiNghiHuuController_ViewControlsCreated(object sender, EventArgs e)
        {
            DetailView view = View as DetailView;
            //ObjectSpace obs = Application.CreateObjectSpace();
            if (view != null)
            {
                DanhSachDenTuoiNghiHuu danhSachDenTuoiNghiHuu = view.CurrentObject as DanhSachDenTuoiNghiHuu;
                if (danhSachDenTuoiNghiHuu != null)
                {
                                ...
                                button.Click += (se, ea) =>
                                    {
                                        ...
                                        {
                                            danhSachDenTuoiNghiHuu.LoadData();
                                        }
                                    };
                            }
                        }
