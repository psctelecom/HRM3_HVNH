...
{
    public partial class DanhGia_DanhSachDanhGiaLan1Controller : ViewController
    {
        public DanhGia_DanhSachDanhGiaLan1Controller()
        {
            InitializeComponent();
            RegisterActions(components);
            HamDungChung.DebugTrace("DanhGia_DanhSachDanhGiaLan1Controller");
        }
        ...
        private void simpleAction2_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            using (DialogUtil.AutoWait())
            {
                ...
                ChiTietDanhGiaCanBoCuoiNamLan1 chiTietLan1 = View.CurrentObject as ChiTietDanhGiaCanBoCuoiNamLan1;
                if (chiTietLan1 != null)
                {
                    ...
                    DataProvider.ExecuteNonQuery("dbo.spd_DanhGia_DanhGiaCanBoCuoiNamLan1", System.Data.CommandType.StoredProcedure, param);
