...
{
    public partial class NghiPhep_TinhSoNgayPhepNamController : ViewController
    {
        public NghiPhep_TinhSoNgayPhepNamController()
        {
            InitializeComponent();
        ...
        private void NghiPhep_TinhSoNgayPhepNamController_Activated(object sender, EventArgs e)
        {
