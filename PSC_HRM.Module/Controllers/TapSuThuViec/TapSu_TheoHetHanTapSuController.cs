...
{
    public partial class TapSu_TheoHetHanTapSuController : ViewController
    {
        public TapSu_TheoHetHanTapSuController()
        {
            InitializeComponent();
        ...
        private void BoNhiem_TheoDoiBoNhiemController_ViewControlsCreated(object sender, EventArgs e)
        {
            ...
            if (view != null)
            {
                DanhSachHetHanTapSu theoDoiTapSu = view.CurrentObject as DanhSachHetHanTapSu;
