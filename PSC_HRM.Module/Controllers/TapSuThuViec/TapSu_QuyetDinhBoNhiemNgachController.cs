...
{
    public partial class TapSu_QuyetDinhBoNhiemNgachController : ViewController
    {
        private IObjectSpace obs;
        private ThongTinHetHanTapSu hetHanTapSu;
        private QuyetDinhBoNhiemNgach quyetDinh;

        public TapSu_QuyetDinhBoNhiemNgachController()
        {
            InitializeComponent();
            RegisterActions(components);
            HamDungChung.DebugTrace("TapSu_QuyetDinhBoNhiemNgachController");
        }
