...
{
    public partial class BoiDuong_TimKiemQuyetDinhBoiDuongController : ViewController
    {
        private IObjectSpace _obs;
        QuyetDinh_TimNhanVien _view;

        public BoiDuong_TimKiemQuyetDinhBoiDuongController()
        {
            InitializeComponent();
            RegisterActions(components);
            HamDungChung.DebugTrace("BoiDuong_TimKiemQuyetDinhBoiDuongController");
        }
        ...
        private void BoiDuong_TimKiemQuyetDinhBoiDuongController_Activated(object sender, EventArgs e)
        {
