...
{
    public class TaoSoHopDongKhoan : MaQuanLyBase
    {
        public override string TaoMaQuanLy(params System.Data.SqlClient.SqlParameter[] args)
        {
            ...
            {
                int soThuTu;
                object obj = DataProvider.GetObject("spd_System_TaoSoHopDongKhoan", System.Data.CommandType.StoredProcedure, args);
                if (obj != null)
                {
