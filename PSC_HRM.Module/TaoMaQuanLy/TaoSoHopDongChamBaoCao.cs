...
{
    public class TaoSoHopDongChamBaoCao : MaQuanLyBase
    {
        public override string TaoMaQuanLy(params System.Data.SqlClient.SqlParameter[] args)
        {
            ...
            if (cauHinh != null
                ...
                && cauHinh.CauHinhHopDong.MauSoHopDongChamBaoCao.IsTemplate())
            {
                int soThuTu;
                object obj = DataProvider.GetObject("spd_System_TaoSoHopDongChamBaoCao", System.Data.CommandType.StoredProcedure, args);
                if (obj != null)
                {
                    ...
                    soThuTu = cauHinh.CauHinhHopDong.SoBatDau;
                return cauHinh.CauHinhHopDong.MauSoHopDongChamBaoCao.CreateTemplate(soThuTu);
            }
            return string.Empty;
        }
    }
