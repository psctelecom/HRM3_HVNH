...
{
    public class TaoSoHopDongThanhLyThinhGiang : MaQuanLyBase
    {
        public override string TaoMaQuanLy(params System.Data.SqlClient.SqlParameter[] args)
        {
            ...
            if (cauHinh != null
                ...
                && cauHinh.CauHinhHopDong.MauSoHopDongThanhLyThinhGiang.IsTemplate())
            {
                int soThuTu;
                object obj = DataProvider.GetObject("spd_System_TaoSoHopDongThanhLyThinhGiang", System.Data.CommandType.StoredProcedure, args);
                if (obj != null)
                {
                    ...
                    soThuTu = cauHinh.CauHinhHopDong.SoBatDau;
                return cauHinh.CauHinhHopDong.MauSoHopDongThanhLyThinhGiang.CreateTemplate(soThuTu);
            }
            return string.Empty;
        }
    }
