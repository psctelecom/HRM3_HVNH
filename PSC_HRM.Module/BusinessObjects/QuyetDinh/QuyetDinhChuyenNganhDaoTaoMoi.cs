...
namespace PSC_HRM.Module.QuyetDinh
{
    ...
    [ModelDefault("Caption", "Quyết định chuyển ngành đào tạo mới")]
    public class QuyetDinhChuyenNganhDaoTaoMoi : QuyetDinhCaNhan
    {
        // Fields...
        ...
        public QuyetDinhChuyenNganhDaoTaoMoi(Session session) : base(session) { }
        ...
        public override void AfterConstruction()
        {
            ...
            //if (string.IsNullOrWhiteSpace(NoiDung))
                //NoiDung = HamDungChung.CauHinhChung.CauHinhQuyetDinh.QuyetDinhChuyenNganhDaoTaoMoi;
        }
