...
{
    public class QuyetDinhTiepNhanHVNH : IQuyetDinhTiepNhanService
    {
                    ...
                    if (obj.QuyetDinhMoi)
                    {
                        ...
                        if (obj.TuNgay <= HamDungChung.GetServerTime())
                        {
                            ...
                            if (obj.MocNangLuongDieuChinhMoi != DateTime.MinValue)
                            {
                                ...
                                obj.ThongTinNhanVien.NhanVienThongTinLuong.LyDoDieuChinh = string.Concat(obj.ThongTinNhanVien.NhanVienThongTinLuong.LyDoDieuChinh, " Nghỉ không hưởng lương.");
                            }
                        }
                    }
                }
