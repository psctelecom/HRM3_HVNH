...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp thanh toán tiền lương theo tình trạng")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangTongHopThanhToanTienLuongTheoTinhTrang : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangTongHopThanhToanTienLuongTheoTinhTrang(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangTongHopThanhToanTienLuongTheoTT", (SqlConnection)Session.Connection))
            {
