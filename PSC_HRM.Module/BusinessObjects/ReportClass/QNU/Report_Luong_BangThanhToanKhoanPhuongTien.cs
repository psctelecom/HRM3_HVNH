...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán khoán phương tiện")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanKhoanPhuongTien : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanKhoanPhuongTien(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_KhoanPhuongTien", (SqlConnection)Session.Connection))
            {
