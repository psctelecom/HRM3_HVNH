...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền lương hợp đồng lao động ngắn hạn")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanTienLuongHDLDNH : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanTienLuongHDLDNH(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangThanhToanTienLuongHDLDNH", (SqlConnection)Session.Connection))
            {
