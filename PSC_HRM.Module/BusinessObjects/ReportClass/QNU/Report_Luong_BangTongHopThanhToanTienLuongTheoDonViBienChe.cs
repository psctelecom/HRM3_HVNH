...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp thanh toán tiền lương theo đơn vị biên chế")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangTongHopThanhToanTienLuongTheoDonViBienChe : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangTongHopThanhToanTienLuongTheoDonViBienChe(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangTongHopThanhToanTienLuongTheoDVBienChe", (SqlConnection)Session.Connection))
            {
