...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán khoán ngoài giờ")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanKhoanNgoaiGio : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanKhoanNgoaiGio(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_KhoanNgoaiGio", (SqlConnection)Session.Connection))
            {
