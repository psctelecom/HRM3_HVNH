...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp thanh toán tiền lương dài hạn theo đơn vị (QNU)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangTongHopThanhToanTienLuongDaiHanTheoDonVi: StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangTongHopThanhToanTienLuongDaiHanTheoDonVi(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangTongHopThanhToanTienLuongTheoDV", (SqlConnection)Session.Connection))
            {
