...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán phụ cấp ưu đãi")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanPhuCapUuDaiQNU : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanPhuCapUuDaiQNU(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangThanhToanPhuCapUuDai", (SqlConnection)Session.Connection))
            {
