...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng chuyển khoản tiền lương hợp đồng lao động ngắn hạn")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangChuyenKhoanTienLuongHDLDNH : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangChuyenKhoanTienLuongHDLDNH(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangChuyenKhoanTienLuongHDLDNH", (SqlConnection)Session.Connection))
            {
