...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Danh sách chuyển bảo hiểm hợp đồng lao động ngắn hạn")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_DanhsachChuyenBaoHiemHDLDNH : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_DanhsachChuyenBaoHiemHDLDNH(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_DanhSachChuyenBaoHiemHDLDNH", (SqlConnection)Session.Connection))
            {
