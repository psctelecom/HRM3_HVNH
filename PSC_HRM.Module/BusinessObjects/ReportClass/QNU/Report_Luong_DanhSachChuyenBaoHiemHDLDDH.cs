...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: danh sách chuyển bảo hiểm hợp đồng lao động dài hạn")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_DanhSachChuyenBaoHiemHDLDDH : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_DanhSachChuyenBaoHiemHDLDDH(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_DanhSachChuyenBaoHiemHDLDDH", (SqlConnection)Session.Connection))
            {
