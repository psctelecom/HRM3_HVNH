...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền lương và thu nhập tăng thêm (NEU)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanLuongVaThuNapTangThem : StoreProcedureReport,IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanLuongVaThuNapTangThem(Session session) : base(session) { }
