...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng thanh toán tiền lương và thu nhập tăng thêm theo đơn vị (NEU)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangThanhToanLuongVaThuNhapTangThemTheoDonVi : StoreProcedureReport,IBoPhan
    {
        ...
        public Report_Luong_BangThanhToanLuongVaThuNhapTangThemTheoDonVi(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("spd_Report_Luong_BangThanhToanLuongVaThuNhapTangThem", (SqlConnection)Session.Connection))
            {
