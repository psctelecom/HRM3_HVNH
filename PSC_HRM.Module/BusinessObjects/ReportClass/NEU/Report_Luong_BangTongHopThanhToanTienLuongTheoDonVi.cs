...
namespace PSC_HRM.Module.ThuNhap.Report
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp thanh toán tiền lương theo đơn vị (NEU)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangTongHopThanhToanTienLuongTheoDonVi : StoreProcedureReport, IBoPhan
    {
        ...
        public Report_Luong_BangTongHopThanhToanTienLuongTheoDonVi(Session session) : base(session) { }
