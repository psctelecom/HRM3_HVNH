...
namespace PSC_HRM.Module.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Mẫu báo cáo kết quả tổ chức hội thảo chuyên môn học viện")]
    [Appearance("Report_NhanSu_MauBaoCaoKetQuaToaDamChuyenMonTaiHocVien", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaBoPhan")]
    public class Report_NhanSu_MauBaoCaoKetQuaToaDamChuyenMonTaiHocVien : StoreProcedureReport
    {
        ...
        public Report_NhanSu_MauBaoCaoKetQuaToaDamChuyenMonTaiHocVien(Session session) : base(session) { }
