...
namespace PSC_HRM.Module.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Cá nhân chưa tự đánh giá")]
    [Appearance("Report_DanhGiaKPI_CaNhanChuaDanhGia", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaBoPhan")]
    public class Report_DanhGiaKPI_CaNhanChuaDanhGia : StoreProcedureReport
    {
        private bool _TatCaBoPhan = true;
        private BoPhan _BoPhan;
        private QuanLyDanhGiaKPI _QuanLyDanhGiaKPI;

        public Report_DanhGiaKPI_CaNhanChuaDanhGia(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cm = new SqlCommand("[dbo].[spd_Report_DanhGiaKPI_CaNhanChuaDanhGia]");
