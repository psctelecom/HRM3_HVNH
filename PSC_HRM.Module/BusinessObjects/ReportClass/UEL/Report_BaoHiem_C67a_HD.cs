...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo: Danh sách đề nghị hưởng chế độ thai sản (Mẫu C67a-HD)")]
    public class Report_BaoHiem_C67a_HD : StoreProcedureReport
    {
        // Fields...
        ...
        public Report_BaoHiem_C67a_HD(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_BaoHiem_C67a_HD",
