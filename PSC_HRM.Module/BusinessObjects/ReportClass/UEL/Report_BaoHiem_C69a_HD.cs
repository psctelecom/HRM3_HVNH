...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo: Danh sách đề nghị hưởng trợ cấp nghỉ DS-PHSK sau thai sản (Mẫu C69a-HD)")]
    public class Report_BaoHiem_C69a_HD : StoreProcedureReport
    {
        // Fields...
        ...
        public Report_BaoHiem_C69a_HD(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_BaoHiem_C69a_HD",
