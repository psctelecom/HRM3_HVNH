...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo: Danh sách đề nghị hưởng chế độ ốm đau (Mẫu C66a-HD)")]
    public class Report_BaoHiem_C66a_HD : StoreProcedureReport
    {
        // Fields...
        ...
        public Report_BaoHiem_C66a_HD(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //SqlCommand cmd = DataProvider.GetCommand("spd_Report_BaoHiem_C66a_HD",
