...
namespace PSC_HRM.Module.BusinessObjects.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Phiếu báo danh giảng viên")]
    public class Report_TuyenDung_PhieuBaoDanhGiangVien : StoreProcedureReport
    {
        ...
        public Report_TuyenDung_PhieuBaoDanhGiangVien(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_TuyenDung_PhieuBaoDanhGiangVien",
