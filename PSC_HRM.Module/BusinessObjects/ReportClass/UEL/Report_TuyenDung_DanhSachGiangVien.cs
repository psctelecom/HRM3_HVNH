...
namespace PSC_HRM.Module.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Danh sách ứng tuyển ứng viên")]
    public class Report_TuyenDung_DanhSachGiangVien : StoreProcedureReport
    {
        ...
        public Report_TuyenDung_DanhSachGiangVien(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            param[3] = new SqlParameter("@ViTriTuyenDung", ChiTietTuyenDung.ViTriTuyenDung.Oid);

            SqlCommand cmd = DataProvider.GetCommand("spd_Report_TuyenDung_DanhSachUngVien",
