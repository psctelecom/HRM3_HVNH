...
namespace PSC_HRM.Module.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Kết quả xét tuyển viên chức")]
    public class Report_TuyenDung_KetQuaXetTuyenVienChuc : StoreProcedureReport
    {
        ...
        public Report_TuyenDung_KetQuaXetTuyenVienChuc(Session session) : base(session) { }
        ...
        {
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_TuyenDung_KetQuaXetTuyenVienChuc",
