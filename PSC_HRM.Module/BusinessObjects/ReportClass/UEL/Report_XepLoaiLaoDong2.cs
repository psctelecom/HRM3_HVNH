...
namespace PSC_HRM.Module.Report
{
    ...
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Đánh giá cán bộ lần 2")]
    [Appearance("Report_XepLoaiLaoDong2.TatCaBoPhan", TargetItems =  "BoPhan", Enabled = false, Criteria = "TatCaBoPhan")]
    public class Report_XepLoaiLaoDong2 : StoreProcedureReport, IBoPhan
    {
        private bool _TatCaBoPhan = true;
        private BoPhan _BoPhan;
        private DateTime _Thang = DateTime.Today;

        public Report_XepLoaiLaoDong2(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cm = new SqlCommand("spd_Report_XepLoaiLaoDong2");
