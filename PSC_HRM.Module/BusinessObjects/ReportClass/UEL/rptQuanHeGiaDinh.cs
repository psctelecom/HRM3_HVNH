...
namespace PSC_HRM.Module.Report
{
    ...
    [ImageName("BO_Report")]
    [ModelDefault("Caption","Báo cáo Hoàn cảnh kinh tế, quan hệ gia đình")]
    public class rptQuanHeGiaDinh : StoreProcedureReport, IBoPhan
    {
        public rptQuanHeGiaDinh(Session session) : base(session) { }
        ...
        {
            SqlCommand cm = new SqlCommand("spd_QuanHeGiaDinh");
