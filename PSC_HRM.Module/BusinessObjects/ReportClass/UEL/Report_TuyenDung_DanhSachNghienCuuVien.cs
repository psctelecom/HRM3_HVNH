...
namespace PSC_HRM.Module.ReportClass
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Danh sách ứng tuyển ngạch nghiên cứu viên")]
    public class Report_TuyenDung_DanhSachNghienCuuVien : StoreProcedureReport
    {
        ...
        public Report_TuyenDung_DanhSachNghienCuuVien(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_TuyenDung_DanhSachNghienCuuVien",
