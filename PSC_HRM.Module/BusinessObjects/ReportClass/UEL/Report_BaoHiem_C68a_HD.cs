...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo: Danh sách đề nghị hưởng trợ cấp nghỉ DS-PHSK sau ốm đau (Mẫu C68a-HD)")]
    public class Report_BaoHiem_C68a_HD : StoreProcedureReport
    {
        // Fields...
        ...
        public Report_BaoHiem_C68a_HD(Session session) : base(session) { }
        ...
        public override void FillDataSource()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_BaoHiem_C68a_HD",
