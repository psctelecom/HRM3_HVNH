...
namespace PSC_HRM.Module.Report
{
    ...
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo Quan hệ xã hội")]
    public class rptQuanHeXaHoi : StoreProcedureReport, IBoPhan
    {
        public rptQuanHeXaHoi(Session session) : base(session) { }
        ...
        {
            SqlCommand cm = new SqlCommand("spd_QuanHeGiaDinhXaHoi");
