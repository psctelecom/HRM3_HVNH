...
namespace PSC_HRM.Module.TuyenDung
{
    ...
    [ModelDefault("Caption", "Nhu cầu tuyển dụng")]
    [RuleCombinationOfPropertiesIsUnique("NhuCauTuyenDung", DefaultContexts.Save, "ViTriTuyenDung;BoPhan;BoMon")]
    [Appearance("Hide_BUH", TargetItems = "BoMon", Visibility = ViewItemVisibility.Hide, Criteria = "MaTruong = 'BUH'")]
    public class NhuCauTuyenDung : TruongBaseObject, IBoPhan
    {
        // Fields...
        ...
        {
            if (BoMonList == null)
                BoMonList = new XPCollection<BaoMat.BoPhan>(Session);
