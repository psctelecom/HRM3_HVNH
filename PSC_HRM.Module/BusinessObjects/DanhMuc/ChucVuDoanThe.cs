...
namespace PSC_HRM.Module.DanhMuc
{
    [DefaultClassOptions]
    [ImageName("BO_List")]
    [DefaultProperty("TenChucVuDoanThe")]
    [ModelDefault("Caption", "Chức vụ Đoàn thể")]
    public class ChucVuDoanThe : BaseObject
    {
        private decimal _HSPCChucVuDoanThe;
        private decimal _PhuCapChucVu;
        private string _MaQuanLy;
        private string _TenChucVuDoanThe;
        ...
        [RuleRequiredField(DefaultContexts.Save)]      
        public string TenChucVuDoanThe
        {
            get
            {
                return _TenChucVuDoanThe;
            }
            set
            {
                SetPropertyValue("TenChucVuDoanThe", ref _TenChucVuDoanThe, value);
            }
        }
        ...
        public decimal HSPCChucVuDoanThe
        {
            get
            {
                return _HSPCChucVuDoanThe;
            }
            set
            {
                SetPropertyValue("HSPCChucVuDoanThe", ref _HSPCChucVuDoanThe, value);
            }
        }
        ...
        public ChucVuDoanThe(Session session) : base(session) { }
    }
