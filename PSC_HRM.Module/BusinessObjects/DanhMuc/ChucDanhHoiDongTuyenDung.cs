...
namespace PSC_HRM.Module.DanhMuc
{
    ...
    [ModelDefault("Caption", "Chức danh hội đồng tuyển dụng")]
    public class ChucDanhHoiDongTuyenDung : BaseObject
    {
        ...
        public ChucDanhHoiDongTuyenDung(Session session) : base(session) { }
    }
