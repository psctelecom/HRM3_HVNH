...
namespace PSC_HRM.Module.ChuyenNgach
{
    ...
    [ModelDefault("Caption", "Chi tiết đề nghị chuyển ngạch")]
    [RuleCombinationOfPropertiesIsUnique(DefaultContexts.Save, "DeNghiChuyenNgach;ThongTinNhanVien")]
    public class ChiTietDeNghiChuyenNgach : BaseObject
    {
        // Fields...
        ...
        [ImmediatePostData]
        [ModelDefault("Caption", "Ngạch lương hiện hượng")]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [ImmediatePostData]
        [ModelDefault("Caption", "Bậc lương hiện hưởng")]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        [ModelDefault("Caption", "Hệ số lương hiện hưởng")]
        [RuleRequiredField(DefaultContexts.Save)]
        ...
        public ChiTietDeNghiChuyenNgach(Session session) : base(session) { }
