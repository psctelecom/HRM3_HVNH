...
{
    public class Non_QuyetDinhChuyenTruongDaoTao : Non_QuyetDinhNhanVien
    {
        ...
        [System.ComponentModel.DisplayName("Trường đào tạo mới")]
        public string TruongDaoTaoMoi { get; set; }
    }
}
