...
{
    public class Non_ChiTietQuyetDinhThamDuHoiThiTayNgheTreMaster : Non_MergeItem
    {
        ...
        [System.ComponentModel.DisplayName("Tổng số người")]
        public string TongSoNguoi { get; set; }
    }
}
