...
{
    public class Non_QuyetDinhDieuChinhThoiGianDiDaoTaoCaNhan : Non_QuyetDinhNhanVien
    {
        ...
        [System.ComponentModel.DisplayName("Thời gian điều chỉnh")]
        public string ThoiGianDieuChinh { get; set; }
