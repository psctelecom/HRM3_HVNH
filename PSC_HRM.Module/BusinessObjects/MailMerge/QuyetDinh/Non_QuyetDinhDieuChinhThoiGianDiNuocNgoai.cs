...
{
    public class Non_QuyetDinhDieuChinhThoiGianDiNuocNgoai : Non_QuyetDinh
    {
        ...
        public Non_QuyetDinhDieuChinhThoiGianDiNuocNgoai()
        {
            Master = new List<Non_ChiTietQuyetDinhDieuChinhThoiGianDiNuocNgoaiMaster>();
            Detail = new List<Non_ChiTietQuyetDinhDieuChinhThoiGianDiNuocNgoaiDetail>();
        }
    }
}
