...
{
    public class Non_QuyetDinhTiepNhanDaoTao : Non_QuyetDinh
    {
        ...
        public Non_QuyetDinhTiepNhanDaoTao()
        {
            Master = new List<Non_ChiTietQuyetDinhTiepNhanDaoTaoMaster>();
            Detail = new List<Non_ChiTietQuyetDinhTiepNhanDaoTaoDetail>();
        }
    }
}
