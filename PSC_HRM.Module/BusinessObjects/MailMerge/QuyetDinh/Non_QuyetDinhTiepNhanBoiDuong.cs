...
{
    public class Non_QuyetDinhTiepNhanBoiDuong : Non_QuyetDinh
    {
        ...
        public Non_QuyetDinhTiepNhanBoiDuong()
        {
            Master = new List<Non_ChiTietQuyetDinhTiepNhanBoiDuongMaster>();
            Detail = new List<Non_ChiTietQuyetDinhTiepNhanBoiDuongDetail>();
        }
    }
}
