...
{
    public class Non_QuyetDinhDiCongTac : Non_QuyetDinh
    {
        ...
        public Non_QuyetDinhDiCongTac()
        {
            Master = new List<Non_ChiTietQuyetDinhDiCongTacMaster>();
            Detail = new List<Non_ChiTietQuyetDinhDiCongTacDetail>();
        }
    }
}
