...
namespace PSC_HRM.Module.HoSo
{
    ...
    public class 
        ChiTietTrichDanhSachNhanVien : BaseObject, IBoPhan, ISupportController
    {
        ...
        public string LoaiHopDong
        {
            get
            {
                return NhanVien.HopDongHienTai != null ? NhanVien.HopDongHienTai.LoaiHopDong : string.Empty;
            }
        }
        ...
        public SucKhoe TinhTrangSucKhoe
        {
            get
            {
                return NhanVien.TinhTrangSucKhoe;
            }
        }
        ...
        public bool GiangDayMonChung
        {
            get
            {
                return NhanVien.GiangDayMonChung;
            }
        }
        ...
        public NganhDaoTao NganhGiangDayDaiHoc
        {
            get
            {
                return NhanVien.NganhGiangDayDaiHoc;
            }
        }
        ...
        public NganhDaoTao NganhGiangDayThacSi
        {
            get
            {
                return NhanVien.NganhGiangDayThacSi;
            }
        }
        ...
        public NganhDaoTao NganhGiangDayTienSi
        {
            get
            {
                return NhanVien.NganhGiangDayTienSi;
            }
        }
        ...
        public ChuyenNganhGiangDay ChuyenNganhGiangDay
        {
            get
            {
                return NhanVien.ChuyenNganhGiangDay;
            }
        }

        public ChiTietTrichDanhSachNhanVien(Session session) : base(session) { }
    }
}
