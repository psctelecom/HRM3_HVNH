...
{
    public partial class ThongKeBienCheController : ThongKeBaseController
    {
        //
        public ThongKeBienCheController(XafApplication app)
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dataList = DataProvider.GetDataTable("spd_BieuDo_ThongKeBienChe", CommandType.StoredProcedure);
            //
