...
using System.Text;
using PSC_HRM.Module.Win.Controllers.Enums;
using PSC_HRM.Module.Win.Controllers.Info;

namespace PSC_HRM.Module.Win.Controllers.Utilities
{
    internal class DeviceManipulator
    {
        ...
        public ICollection<MachineInfo> LayDuLieuChamCong(ZkemClient objZkeeper, int machineNumber)
        {
            ...
            ICollection<MachineInfo> lstChamCongData = new List<MachineInfo>();
            ...
            while (objZkeeper.SSR_GetGeneralLogData(machineNumber, out dwEnrollNumber1, out dwVerifyMode, out dwInOutMode, out dwYear, out dwMonth, out dwDay, out dwHour, out dwMinute, out dwSecond, ref dwWorkCode))
            {
                ...
                objInfo.MachineNumber = machineNumber;          //SN
                objInfo.IndRegID = int.Parse(dwEnrollNumber1);  //USERID
                objInfo.DateTimeRecord = inputDate;             //CHECKTIME

                lstChamCongData.Add(objInfo);
            }

            return lstChamCongData;
        }
