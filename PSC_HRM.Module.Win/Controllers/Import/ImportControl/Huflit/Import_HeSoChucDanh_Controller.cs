...
{
    public partial class Import_HeSoChucDanh_Controller : ViewController
    {
        IObjectSpace _obs = null;
        public Import_HeSoChucDanh_Controller()
        {
            InitializeComponent();
        ...
        void Import_HeSoChucDanh_Controller_Activated(object sender, System.EventArgs e)
        {
        ...
        private void btImport_UpdateVanBang_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            QuanLyHeSo qly = View.CurrentObject as QuanLyHeSo;
            View.ObjectSpace.CommitChanges();
            Import_HeSoChucDanhNhanVien.XuLy(_obs, qly.Oid);
            _obs.Refresh();
        }
    }
}
