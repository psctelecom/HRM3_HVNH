...
{
    public partial class PMS_ImportThuLaoGiangDay_Controller : ViewController
    {
        IObjectSpace _obs = null;
        public PMS_ImportThuLaoGiangDay_Controller()
        {
            InitializeComponent();
        ...
        void PMS_ImportThuLaoGiangDay_Controller_Activated(object sender, System.EventArgs e)
        {
            if (TruongConfig.MaTruong == "NEU" || TruongConfig.MaTruong == "HUFLIT")
            {
                btImportThuLao.Active["TruyCap"] = false;
            }
        }
            ...
            //{
                ...
                if (OidQuanLy != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            string sql = "DELETE ChiTietThanhToanKhoiLuongGiangDay";
                            sql += " FROM QuanLyHoatDongKhac";
                            sql += " JOIN dbo.ChiTietThanhToanKhoiLuongGiangDay ON ChiTietThanhToanKhoiLuongGiangDay.QuanLyHoatDongKhac = QuanLyHoatDongKhac.Oid";
                        ...
                        Imp_ChiTietThanhToanKhoiLuongGiangDay.XuLy(_obs, OidQuanLy);
                        _obs.Refresh();
                    }
                }
            //}
