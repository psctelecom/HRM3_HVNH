...
{
    public partial class PMS_ImportBoiDuongThuongXuyen_Controller : ViewController
    {
        IObjectSpace _obs = null;
        public PMS_ImportBoiDuongThuongXuyen_Controller()
        {
            InitializeComponent();
            ...
            //{
                ...
                if (OidQuanLy != null)
                {
                    if (OidQuanLy.BangChotThuLao == null)
                    {
                        ...
                        Imp_BoiDuongThuongXuyen.XuLy(_obs, OidQuanLy);
                        _obs.Refresh();
                    }
                    else
