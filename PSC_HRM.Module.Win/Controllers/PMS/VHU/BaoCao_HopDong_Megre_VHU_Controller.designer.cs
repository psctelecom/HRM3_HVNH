...
{
    partial class BaoCao_HopDong_Megre_VHU_Controller
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // btSearch
            // 
            this.btSearch.Caption = "In hợp đồng";
            this.btSearch.ConfirmationMessage = null;
            this.btSearch.Id = "BaoCao_HopDong_VHU_Controller";
            this.btSearch.ImageName = "BO_ChiTietLuong";
            this.btSearch.TargetObjectType = typeof(PMS_ThanhToanThuLaoGiangDay_HopDong_NonBaoCao);
