...
{
    public partial class HoSo_ChinhCotListViewController : ViewController
    {
        public HoSo_ChinhCotListViewController()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (gridControl != null)
            {
                ...
                if (gridView != null)
                {
                    using (frmListViewColumns dialog = new frmListViewColumns(typeof(ChiTietTrichDanhSachNhanVien)))
                    {
