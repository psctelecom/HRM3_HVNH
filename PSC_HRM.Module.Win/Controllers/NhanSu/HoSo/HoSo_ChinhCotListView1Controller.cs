...
{
    public partial class HoSo_ChinhCotListView1Controller : ViewController
    {
        public HoSo_ChinhCotListView1Controller()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (gridControl != null)
            {
                ...
                if (gridView != null)
                {
                    using (frmListViewColumns dialog = new frmListViewColumns(typeof(ChiTietTrichDanhSachThinhGiang)))
                    {
