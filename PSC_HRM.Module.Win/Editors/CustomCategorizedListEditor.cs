...
{
    public class CustomCategorizedListEditor : GridListEditor, IComplexListEditor
    {
        // Fields
        ...
        // Methods
        public CustomCategorizedListEditor(IModelListView info)
            : base(info)
        {
            locker = new Locker();
            ...
            try
            {
                ...
                if (CategoriesListView != null)
                {
                    ...
                    if (currentObject != null)
                    {
                        ...
                        {
                            //
                            if ((((BoPhan)currentObject).ListBoPhanCon != null && ((BoPhan)currentObject).ListBoPhanCon.Count > 0) || ((BoPhan)currentObject).LoaiBoPhan != LoaiBoPhanEnum.BoMonTrucThuocKhoa)
                            {
    ...
    internal class CategorizedListEditorPropertyDescriptor : System.ComponentModel.PropertyDescriptor
    {
        // Fields
        ...
        // Methods
        public CategorizedListEditorPropertyDescriptor(System.ComponentModel.PropertyDescriptor descriptor, Type declaringType)
            : base(descriptor)
        {
